...
export const metadata: Metadata = {
  title: 'Kalangan - Traditional Indian Jewelry Booking',
  description: 'Book your perfect traditional jewelry for special occasions. Elegant designs, expert craftsmanship.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
